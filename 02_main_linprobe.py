...
def get_args_parser():
    ...
    parser.add_argument('--warmup_epochs', type=int, default=5, metavar='N',
                        help='epochs to warmup LR') # make 5 to match w/ finetune
    ...
    parser.add_argument('--output_dir', default='./output_linprobe_dir2',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_linprobe_dir2',
